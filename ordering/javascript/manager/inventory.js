...
class InventoryManager {
    ...
    async loadInventoryData() {
        try {
            ...
            const response = await fetch(`/public/api/get_inventory_products.php?${params}`);
    ...
    async testDatabaseConnection() {
        try {
            const response = await fetch('/public/api/test_db.php');
            const result = await response.json();
    ...
    async debugInventory() {
        try {
            const response = await fetch('/public/api/debug_inventory.php');
