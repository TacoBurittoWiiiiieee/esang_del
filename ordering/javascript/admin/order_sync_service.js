...
class OrderSyncService {
    ...
    async poll() {
        ...
        try {
            const url = `/public/api/order_status_sync.php?poll_type=${this.pollType}&last_sync=${this.lastSync}`;
    ...
    async updateOrderStatus(orderId, action) {
        try {
            const response = await fetch('/public/api/order_status_sync_dev.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
