class AdminOrderStatus {
    ...
    async loadOrders() {
        ...
        try {
            ...
            const response = await fetch('http://esangdelicacies.com/public/api/get_pending_orders.php');
    ...
    async viewOrderDetails(orderId) {
        try {
            const response = await fetch(`http://esangdelicacies.com/public/api/get_order_details.php?order_id=${orderId}`);
    ...
    async updateOrderStatus(orderId, action) {
        ...
        try {
            ...
            if (this.syncService) {
                ...
                const response = await fetch('http://esangdelicacies.com/public/api/update_order_status.php', {
                    method: 'POST',
                    headers: {
